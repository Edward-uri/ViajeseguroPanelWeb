...
import { QueueIcon, VehicleIcon, DriversIcon, ReportsIcon, ZonesIcon, AdminsIcon, SettingsIcon } from '../shared/icons'
...
export const navItems: NavItem[] = [
  ...
  { label: 'Reportes', to: paths.reportes, icon: <ReportsIcon size={ICON_SIZE} /> },
