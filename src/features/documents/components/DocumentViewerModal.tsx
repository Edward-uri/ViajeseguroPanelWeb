      ...
      <div className="mt-4 grid grid-cols-[1fr_300px] gap-6">
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="mt-auto flex flex-col gap-3">
            <Button variant="success" fullWidth disabled={!canDecide} onClick={() => onApprove(document)}>✓ Aprobar documento</Button>
            <Button variant="dangerOutline" fullWidth disabled={!canDecide} onClick={() => onReject(document)}>Rechazar</Button>
          </div>
        </div>
      </div>
    </Modal>
